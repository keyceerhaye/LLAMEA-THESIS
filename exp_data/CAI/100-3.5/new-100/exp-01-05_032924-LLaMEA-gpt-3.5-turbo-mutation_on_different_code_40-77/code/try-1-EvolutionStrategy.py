...
class EvolutionStrategy:
    def __init__(self, budget=10000, dim=10, lambda_=10, sigma=0.1, elite_ratio=0.1):
        self.budget = budget
        self.dim = dim
    ...
    def __call__(self, func):
        ...
        for _ in range(self.budget // self.lambda_):
            ...
            elite_count = int(self.elite_ratio * self.lambda_)
            elite_indices = np.argsort(f)[:elite_count]
            x = offspring[elite_indices]
