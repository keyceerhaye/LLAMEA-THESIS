...
class AdaptiveDE:
    ...
    def adapt_parameters(self):
        self.mutation_factor = np.clip(self.mutation_factor + np.random.normal(0, 0.05), 0.1, 0.9)
        self.crossover_rate = np.clip(self.crossover_rate + np.random.normal(0, 0.05), 0.1, 0.9)
