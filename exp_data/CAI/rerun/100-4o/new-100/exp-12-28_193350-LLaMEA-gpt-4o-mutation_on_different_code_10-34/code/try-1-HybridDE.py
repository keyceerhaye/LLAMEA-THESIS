...
class HybridDE:
    ...
    def parameter_adaptation(self, generation):
        ...
        self.population_size = max(20, int(50 * (1 - generation / self.budget)))
    ...
    def __call__(self, func):
        # Adjust initial population size based on budget
        self.population_size = min(self.population_size, self.budget // 2)
