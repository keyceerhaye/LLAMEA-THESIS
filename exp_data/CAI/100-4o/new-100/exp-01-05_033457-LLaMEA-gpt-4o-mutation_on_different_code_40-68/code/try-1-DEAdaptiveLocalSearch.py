...
class DEAdaptiveLocalSearch:
    def __init__(self, budget=10000, dim=10):
        ...
        self.local_search_prob = 0.1  # Initial probability to do local search
    ...
    def differential_evolution(self, func):
        ...
        for _ in range(self.budget // self.population_size):
            ...
            self.local_search_prob = 0.1 + np.std(fitness) / 10  # Dynamic local search probability
    ...
    def adapt_parameters(self, fitness):
        ...
        self.F = 0.5 + 0.3 * np.random.rand() * diversity
        self.CR = 0.7 + 0.2 * np.random.rand() * diversity
