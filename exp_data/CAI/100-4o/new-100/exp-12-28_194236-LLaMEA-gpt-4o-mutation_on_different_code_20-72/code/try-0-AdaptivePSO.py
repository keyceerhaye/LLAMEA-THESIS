...
class AdaptivePSO:
    def __init__(self, budget=10000, dim=10):
        self.budget = budget
        self.dim = dim
        self.particles = 30  # Number of particles
    ...
    def __call__(self, func):
        ...
        for t in range(self.budget // self.particles):
            ...
            self.w = self.w_min + (0.9 - self.w_min) * ((self.budget // self.particles - t) / (self.budget // self.particles))
