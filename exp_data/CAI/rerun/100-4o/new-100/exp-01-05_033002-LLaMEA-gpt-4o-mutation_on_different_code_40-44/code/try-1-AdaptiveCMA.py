...
class AdaptiveCMA:
    def __init__(self, budget=10000, dim=10):
        ...
        self.sigma = 0.5  # Adjusted initial sampling step size
    ...
    def __call__(self, func):
        ...
        self.lambda_ = int(4 + np.ceil(3 * np.log(self.dim)))  # Dynamic population size
        ...
        while remaining_budget > 0:
            ...
            if remaining_budget > 0:
                ...
                self.D = np.clip(np.sqrt(self.D), 1e-10, 1e10)
