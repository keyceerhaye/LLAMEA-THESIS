...
class ParticleSwarmOptimization:
    def __init__(self, budget=10000, dim=10, swarm_size=30, c1=2.05, c2=2.05, w=0.9, w_min=0.4):
        self.budget = budget
        self.dim = dim
    ...
    def __call__(self, func):
        ...
        while evaluations < self.budget:
            ...
            if evaluations % 50 == 0 and self.swarm_size > 10:  # Dynamically resize swarm
                self.swarm_size -= 1
                ...
                personal_best_scores = personal_best_scores[:self.swarm_size]
