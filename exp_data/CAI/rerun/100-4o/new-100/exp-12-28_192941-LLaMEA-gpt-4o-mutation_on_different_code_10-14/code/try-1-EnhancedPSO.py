...
class EnhancedPSO:
    ...
    def __call__(self, func):
        eval_count = 0
        stagnation_threshold = 100  # Change 1
        no_improvement_iters = 0  # Change 2

        while eval_count < self.budget and no_improvement_iters < stagnation_threshold:  # Change 3
            prev_f_opt = self.f_opt  # Change 4
            ...
            if np.isclose(prev_f_opt, self.f_opt, atol=1e-8):  # Change 5
