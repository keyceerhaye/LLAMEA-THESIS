...
class ParticleSwarmOptimization:
    def __init__(self, budget=10000, dim=10, num_particles=30, w_initial=0.9, w_final=0.4, c1=1.5, c2=1.5):
        self.budget = budget
        self.dim = dim
    ...
    def __call__(self, func):
        ...
        for iteration in range(max_iter):
            w = self.w_initial - (self.w_initial - self.w_final) * (iteration / max_iter)  # dynamic inertia weight
