...
class AdaptivePSO:
    ...
    def __call__(self, func):
        ...
        while function_evaluations < self.budget:
            ...
            convergence_factor = max(0.4, (self.budget - function_evaluations) / self.budget)
            ...
            for idx, particle in enumerate(swarm):
                ...
                cognitive = self.c1 * convergence_factor * r1 * (personal_best_positions[idx] - particle)
                social = self.c2 * convergence_factor * r2 * (global_best_position - particle)
