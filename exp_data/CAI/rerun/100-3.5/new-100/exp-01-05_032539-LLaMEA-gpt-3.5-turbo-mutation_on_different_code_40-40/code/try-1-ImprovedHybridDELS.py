...
class ImprovedHybridDELS:
    ...
    def chaotic_map(self, x):
        return 5.0 * logistic.cdf(x, loc=0, scale=1)
    ...
    def __call__(self, func):
        ...
        for i in range(self.budget):
            ...
            chaotic_factor = self.chaotic_map(target)
            trial = target + chaotic_factor * self.f * (donor[0] - donor[1])
