...
class AdaptiveDifferentialEvolution:
    ...
    def __call__(self, func):
        ...
        secondary_population = population.copy()  # Secondary population for diversification
        ...
        while evaluations < self.budget:
            for i in range(self.pop_size):
                ...
                # Diversification: Swap with secondary population
                if evaluations % 50 == 0:  # Every 50 evaluations
                    population[i], secondary_population[i] = secondary_population[i], population[i]
