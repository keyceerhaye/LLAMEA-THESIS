...
class PSO:
    ...
    def __call__(self, func):
        ...
        while eval_count < self.budget:
            ...
            # Change the c1 and c2 values dynamically based on fitness improvement
            fitness_improvement = 1 - (global_best_score / np.min(personal_best_scores))
            self.c1 = 1.5 + fitness_improvement
            self.c2 = 1.5 + fitness_improvement
