...
class AdaptiveDifferentialEvolution:
    def __init__(self, budget=10000, dim=10):
        ...
        self.budget_used = 0
        self.learning_rate = 0.1  # New learning rate for parameter adaptation
    ...
    def adaptive_parameters(self, fitness):
        ...
        F = np.clip(0.5 + (0.5 - 0.1) * (1 - avg_improvement * self.learning_rate), 0.1, 0.9)  # Adjusted F update
        CR = np.clip(0.9 - (0.9 - 0.1) * avg_improvement * self.learning_rate, 0.1, 0.9)  # Adjusted CR update
        return F, CR