...
class HybridPSO_DE:
    ...
    def __call__(self, func):
        initial_w = 0.9  # Line changed
        final_w = 0.4    # Line changed
        while self.fitness_evaluations < self.budget:
            ...
            # Adaptive PSO update
            w = initial_w - ((initial_w - final_w) * (self.fitness_evaluations / self.budget))  # Line changed
            c1 = 1.5
            c2 = 1.5
            ...
            F = 0.5 + 0.3 * (self.fitness_evaluations / self.budget)  # Line changed
            CR = 0.9
            for i in range(self.population_size):
                if self.fitness_evaluations >= self.budget:
                    break
