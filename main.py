...
from utils import OverBudgetException, NoCodeException, aoc_logger, correct_aoc

# Execution code starts here
api_key = os.getenv("OPENAI_API_KEY")
ai_model = "gpt-4-turbo" # gpt-4-turbo or gpt-3.5-turbo gpt-4o
explogger = ExperimentLogger(f"{ai_model}-elitism")
algorithm_manager = AlgorithmManager(api_key, explogger, ai_model, False , True)
...
for openai_try in np.arange(openai_budget):
    ...
    try:
        ...
        #l1 = logger.Analyzer(folder_name=f"{explogger.dirname}/ioh/try-{openai_try}", algorithm_name=algorithm_name)
        ...
        print(algorithm_manager.last_error)
