...
class AdaptiveDifferentialEvolution:
    def __init__(self, budget=10000, dim=10, population_size=50):
        ...
        self.success_history = []  # Track success for adaption
    ...
    def __call__(self, func):
        ...
        while evaluations < self.budget:
            ...
            # Adaptive adjustment of parameters using success rate
            success_rate = np.mean(self.success_history[-self.population_size:])
            self.mutation_factor = 0.5 + success_rate * 0.5
            self.crossover_rate = 0.5 + success_rate * 0.5
